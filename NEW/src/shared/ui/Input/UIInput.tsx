...
export const UIInput = forwardRef<any, TextFieldProps>(({ defaultValue = "", type = "text", is_search = false, error = false, disabled = false, readOnly = false, rightaligned = false, label, hint, placeholder, value, onChange },ref) => {
    ...
    return (
        <div className="input__box " ref={ref}>
            {/* label */}
