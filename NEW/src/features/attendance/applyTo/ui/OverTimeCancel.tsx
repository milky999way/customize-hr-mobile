...
export const OverTimeCancel = () => {
    ...
    setForm((prev: any) => {
      ...
      return {
        ...
        wcotmcnclreqList: updatedList.map((entry: any, index: any) => ({
          ...entry,
          rowKey: index+1, // PC 테이블 row key 인덱스값
        })),
      };
    });
  };
  ...
  const handleApply = async () => {
    if(form.wcotmcnclreqList.length === 0){
      alert("선택된 항목이 없습니다.");
      return;
    }
    ...
    <>
      ...
      <div className="pt-10 pb-10">
        ...
        <ul className="cancel__list">
          ...
          :
            overTimeCancelData.map((item: any, index: any) =>
            <li key={item.docNo}>
              <div className="cancel">
                ...
                <div className={index+1 !== overTimeCancelData.length? "cancel__info" :"cancel__info pb-60"}>
                  <div className="info">
                    <strong>구분</strong>
