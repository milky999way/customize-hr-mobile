  ...
  const switchTarget = switchData.map((item) => { return {label: item.codeNameHan, error: false, query: item.workCodeKind}})
   ...
   const validateForm = () => {      
    const newErrors = {
      ...
      stopRsn: !form.stopRsn,
      stopDateFrom: !form.stopDateFrom,
      stopDateTo: !form.stopDateTo,
    ...
    <>
      <div className="pt-10 pb-10">
        <UISelect
          ...
          error={errors.stopCode }
          hint={errors.stopCode ? "휴/복직구분을 선택해주세요." : ""}          
        />
      </div>
      <div className="pt-10 pb-10">
        <UIDatePicker
          ...
          readOnly={fieldDisable}
          error={errors.stopDateFrom || errors.stopDateTo }
          hint={errors.stopDateFrom || errors.stopDateTo ? "휴직기간을 선택해주세요." : ""}     
        />
      </div>
      ...
      <div className="d-flex pt-10 pb-10">
        <UICheckbox
          ...
          onChecked={
            (isChecked) => {
              if(isChecked){
                handleSelectChange("npPayPouse", "Y");                
              }else{
                handleSelectChange("npPayPouse", "N");
              }                          
            }
          }
        />
      ...
      <div className="d-flex pt-10 pb-10">
        <UIInput
          ...
          error={errors.stopRsn }
          hint={errors.stopRsn  ? "상세사유를 입력해주세요." : ""}   
      ...
      {fileField &&
        <>
          <div className="pt-10 pb-180">
            ...
            <p className="fs-14 pt-10 text-point-1">* 개인정보가 포함된 서류를 첨부파일로 제출할 경우, 주민등록번호 뒷자리를 가리고 제출해 주세요.</p>
          </div>
        </>
      }
