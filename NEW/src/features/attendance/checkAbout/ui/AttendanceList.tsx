...
export const AttendanceList = () => {
  ...
  // const attendanceFormTarget = attendanceListData.filter((Array, index, calback) => index === calback.findIndex((item) => item.formName === Array.formName)).map((item) => { return {label: item.formName, error: false, query: item.formId}})
      ...
      <div className="pt-10 pb-10">
        ...
        <ul className="list">
          ...
          : attendanceListData.map((item: any, i) => 
            ...
            //       </div>
            //     </PopoverTrigger>
            //     <PopoverContent className="d-flex flex-direction-column custom__popper">
