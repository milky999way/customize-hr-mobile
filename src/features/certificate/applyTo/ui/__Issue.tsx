...
export const Issue = () => {
  ...
  const validateForm = () => {
    const newErrors = {
      certiCodeKind: !form.certiCodeKind,
      certiCodeType: form.certiCodeKind === "1" && !form.certiCodeType,
      issueUse: !form.issueUse,
      positionEng: form.certiCodeType === "E" && !form.positionEng,
      addressEng: form.certiCodeType === "E" && !form.addressEng,
      jobEng: form.certiCodeType === "E" && !form.jobEng,
      pay: form.certiCodeType === "E" && !form.jobEng,
      payDateFrom: form.payDateFrom === "" && !form.payDateFrom,
      issueYear: form.issueYear === "" && !form.issueYear,
    };
      ...
      {form.certiCodeKind === "4" ? // 갑근세증명서
        <div className="pt-10 pb-10">
          <UIDatePicker
            ...
            type="year-month"
            onMonthSelect={(month) => {
              handleSelectChange("payDateFrom", month)
              handleSelectChange("payDateTo", month)
            }}
